        ...
        <div class="auth-cover-sidebar-inner">
            <div class="auth-cover-card-wrapper">
                <div class="auth-cover-card p-sm-5">
                    ...
                    <form wire:submit="register" class="w-100 mt-4 pt-2">
                        <div class="mb-4">
                            <input type="text" wire:model="name" class="form-control" placeholder="Full Name" required autofocus autocomplete="name">
                            @error('name') <span class="text-danger small">{{ $message }}</span> @enderror
                        </div>
                        <div class="mb-4">
                            <input type="email" wire:model="email" class="form-control" placeholder="Email" required autocomplete="username">
                        ...
                        <div class="mb-4 generate-pass">
                            <div class="input-group field">
                                <input type="password" wire:model="password" class="form-control password" id="newPassword" placeholder="Password">
                        ...
                        <div class="mb-4">
                            <input type="password" wire:model="password_confirmation" class="form-control" placeholder="Password again" required autocomplete="new-password">
                        ...
                        <div class="mt-4">
                            <div class="custom-control custom-checkbox mb-2">
                                ...
                                <label class="custom-control-label c-pointer text-muted" for="receiveMial" style="font-weight: 400 !important">Yes, I want to receive Duralux community emails</label>
                            </div>
                    ...
                    <div class="mt-5 text-muted">
                        ...
                        <a href="{{ route('login') }}" class="fw-bold" wire:navigate>Login</a>
                    </div>
                </div>
            </div>
        </div>
