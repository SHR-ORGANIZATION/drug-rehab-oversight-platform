            ...
            <div class="auth-cover-card-wrapper">
                <div class="auth-cover-card p-sm-5">
                    ...
                    <form wire:submit="login" class="w-100 mt-4 pt-2">
                        ...
                        <div class="mb-3">
                            <input type="password" wire:model="form.password" class="form-control" placeholder="Password" required autocomplete="current-password">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('password.request') }}" class="fs-11 text-primary" wire:navigate>Forget password?</a>
                            </div>
                        </div>
                        <div class="mt-5">
